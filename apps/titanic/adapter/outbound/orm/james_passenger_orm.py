"""James 업로드 승객 행 ORM — 원본 CSV + `id`, `Sex` → `gender`."""
...
class JamesPassenger(Base):
    __tablename__ = "titanic_james_passengers"
    ...
    @classmethod
    def from_record(cls, filename: str, row: dict[str, Any]) -> JamesPassenger:
        return cls(
