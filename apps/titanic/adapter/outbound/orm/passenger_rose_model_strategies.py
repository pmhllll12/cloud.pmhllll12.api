...
from titanic.app.ports.input.passenger_rose_model_use_case import RoseModelStrategy
...
class PCAKMeansStrategy(RoseModelStrategy):
    ...
    @property
    def description(self) -> str:
        return "비지도 학습 기반 군집화 및 차원 축소. 분류 모델은 아니지만 승객 그룹을 클러스터링(K-Means)하거나 수많은 피처를 압축(PCA)하여 파생 변수를 만들 때 보조적으로 활용됩니다."
