"""James director — Titanic CSV 업로드 (`/titanic/james`). `schemas/crew_james_director_schema`."""
...
# `api/__init__.py` 및 레거시 코드 호환
james_director_router = crew_james_director_router
james_router = crew_james_director_router


@crew_james_director_router.post("/upload", response_model=JamesDirectorUploadResponse)
async def upload_titanic_file(
    ...
    return james_upload_success_response(records)


@crew_james_director_router.get(
    "/passengers",
